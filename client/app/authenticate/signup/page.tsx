...
const SignUpPage = () => {
  ...
  return (
    <>
      ...
      <aside>
        <h2 className='text-3xl font-semibold uppercase text-center'>Create an account</h2>
        <p>Let's get started with your 30 day free trial</p>
      </aside>
      <form className='mt-5'>
        <input type='text' className='p-2 border-b w-full outline-none' placeholder='Name' name='userName' onChange={onChange}  />
        <input type='email' className='p-2 border-b w-full outline-none mt-5' placeholder='Email' name='email' onChange={onChange}  />
        <input type='password' className='p-2 border-b w-full mt-5 outline-none' placeholder='Password' name='password' 
        onChange={onChange}  />
        <button type='submit' className='mt-8 w-full p-4 bg-black rounded-xl text-white font-semibold uppercase' onClick={handleSubmit}>Create Account</button>
      </form>
      {/* line or */}
      ...
      <aside className='mt-10'>
        ...
        <Link href='/authenticate'><span className='font-semibold'>Log in</span></Link>
      </aside>
    </div>
    </>
